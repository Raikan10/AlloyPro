...
const MOCK_SERVICE_ORDERS: ServiceOrder[] = [
  {
    ...
    fullDetail:
      'Loud grinding noise from AHU-3 supply fan during peak load. Noise increases with fan speed. First noticed Monday morning after weekend shutdown. Building occupants on Level 7 reporting vibration.',
    ...
    serviceHistory: [
      {
        date: '2025-11-20',
        workOrderId: 'WO-0987',
        summary: 'Belt tension adjustment on AHU-3',
        outcome: 'Resolved — noise eliminated',
      },
      {
        date: '2025-06-15',
        workOrderId: 'WO-0812',
        summary: 'AHU-3 bearing lubrication',
        outcome: 'Preventive maintenance completed',
      },
    ],
    isRecurring: true,
    hypothesis: {
      ...
      likelyRootCause:
        'Supply fan drive bearing failure due to misalignment from prior belt tension issue',
      confidence: 'high',
    },
    priorWork: '',
    recommendedParts: [
  ...
  },
  {
    ...
    fullDetail:
      'Projector in main event space producing noticeably dimmer image over past two weeks. Colours appear washed out, especially reds. Lamp hours at 4,200. Client has important presentation next Thursday.',
    ...
    serviceHistory: [
      {
        date: '2025-09-01',
        workOrderId: 'WO-0901',
        summary: 'Lens cleaning and filter replacement',
        outcome: 'Brightness restored to spec',
      },
    ],
    isRecurring: false,
    hypothesis: {
      ...
      likelyRootCause:
        'Laser diode phosphor wheel degradation at 4,200h requiring module replacement',
      confidence: 'medium',
    },
  ...
  },
  {
    ...
    fullDetail:
      'Outdoor VRF unit displaying E3 high-pressure fault. System locks out after 15 minutes of operation. Three floors affected — tenants reporting no cooling since yesterday morning. Ambient temp 28°C.',
    ...
    serviceHistory: [
      {
        date: '2026-01-05',
        workOrderId: 'WO-1001',
        summary: 'Refrigerant top-up on ODU-2',
        outcome: 'System recharged — ran for 6 weeks before re-fault',
      },
      {
        date: '2025-08-22',
        workOrderId: 'WO-0855',
        summary: 'E3 fault investigation',
        outcome: 'Found low refrigerant — topped up and monitored',
      },
    ],
    isRecurring: true,
    hypothesis: {
      ...
      likelyRootCause:
        'Active refrigerant leak at flare joint or service valve causing repeated high-pressure lockout',
      confidence: 'high',
    },
    priorWork:
      'Two previous refrigerant top-ups (Jan 2026, Aug 2025). Leak detection not yet performed — previous visits addressed symptom only.',
    recommendedParts: [
  ...
  },
  {
    ...
    fullDetail:
      'Ultra-short-throw projector image drifting upward over past week. Keystone correction maxed out. Image now 15cm off-screen at top edge. Suspected lens shift motor or encoder fault.',
    ...
    recommendedParts: [
      {
        name: 'FP-Z8000 Lens Shift Motor Assembly',
        sku: 'FUJI-LSM-8K',
        quantity: 1,
        inStock: false,
      },
    ...
    requiredTools: [
      ...
      {
        name: 'Service laptop with Fuji diagnostic software',
        purpose: 'Run motor calibration and firmware check',
      },
    ],
  },
  {
    ...
    fullDetail:
      'BMS triggered condensate pump high-level alarm on FCU-12. Water detected in drip tray. No visible overflow yet but alarm persistent. FCU serving boardroom — client wants resolved before Monday board meeting.',
    ...
    reporter: {
      name: 'Lisa Morgan',
      email: 'l.morgan@theofficegroup.com',
    ...
    serviceHistory: [
      {
        date: '2025-12-10',
        workOrderId: 'WO-0965',
        summary: 'Condensate drain flush on Floor 3 FCUs',
        outcome: 'All drains cleared — preventive maintenance',
      },
    ],
    isRecurring: false,
    hypothesis: {
      ...
      likelyRootCause:
        'Condensate pump float switch stuck or failed, preventing automatic pump activation',
      confidence: 'high',
    },
    priorWork:
      'Resolved — float switch was stuck with biofilm. Cleaned float mechanism and flushed drain line. Pump tested and operating normally.',
    recommendedParts: [
  ...
  },
  {
    ...
    fullDetail:
      'BMS showing 0.8 bar pressure in glycol loop — should be 2.5 bar. Pressure dropping ~0.1 bar per day. No visible leaks in plant room. Chiller cycling on low-flow protection. Two floors losing cooling.',
    ...
    serviceHistory: [
      {
        date: '2025-10-02',
        workOrderId: 'WO-0932',
        summary: 'Annual glycol concentration test',
        outcome: 'Glycol at 32% — within spec',
      },
    ],
    isRecurring: false,
    hypothesis: {
      ...
      likelyRootCause:
        'Hidden glycol leak in ceiling void pipework runs, or failed expansion vessel bladder',
      confidence: 'medium',
    },
    priorWork: '',
    recommendedParts: [
    ...
    requiredTools: [
      {
        ...
        purpose: 'Locate hidden leak via temperature differential',
      },
